...
function nav(){
 var navEle = document.createElement("nav");
  ...
  displayButton.innerHTML="Display Note";
  ...
  navEle.appendChild(displayButton);
  navEle.appendChild(addButton);
...
function displaynote(){
  contentClear()
  contentEle.innerHTML="Display Note";
  writeBlocks(contentEle);
}
function addnote() {
  contentClear()
  var addnoteWrapperEle = document.createElement("div");
  addnoteWrapperEle.innerHTML = "Add Note <br> 'add notes here'";
  // another(addnoteWrapperEle);
  contentEle.appendChild(addnoteWrapperEle);
}
// function another(ano){
//  var stuffEle = document.createElement("div");
//  var note = ["add notes here"];
// }
